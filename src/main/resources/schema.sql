...
CREATE TABLE categoria_gasto (
    ...
    nome VARCHAR(100) NOT NULL,  -- Nome da categoria de gasto (exemplo: Cartão, Casa, etc.)
    icone VARCHAR(100), -- Nome do icone localizado no angular
);
...
CREATE TABLE recursos_usuario (
    ...
    data_inclusao DATE NOT NULL,  -- Data da inclusao
    data_edicao DATE NULL,  -- Data da edicao
...
COMMENT ON COLUMN recursos_usuario.data_inclusao IS 'Data que o usuario incluiu o novo recurso';
COMMENT ON COLUMN recursos_usuario.data_edicao IS 'Data que o usuario editou o recurso';
...
CREATE TABLE meta_gasto (
    ...
    categoria_id  INTEGER REFERENCES categoria_gasto(id) ON DELETE CASCADE NOT NULL,  -- Chave estrangeira para a categoria de gasto
    valor_meta DECIMAL(10, 2) NOT NULL,  -- Valor da meta de gasto para a categoria específica
    data_inclusao DATE NOT NOT NULL,  -- Data da inclusao
    data_edicao DATE NOT NULL,  -- Data da edicao
...
COMMENT ON COLUMN meta_gasto.data_inclusao IS 'Data da inclusao';
COMMENT ON COLUMN meta_gasto.data_edicao IS 'Data da edicao';
...
COMMENT ON COLUMN gasto.data_inclusao IS 'Data da inclusao';
COMMENT ON COLUMN gasto.data_edicao IS 'Data da edicao';
